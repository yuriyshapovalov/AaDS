...
public class SampleSortTest
{
    ...
    public void Init()
    {
        this.sorter = new SampleSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void SampleSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void SampleSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void SampleSort_OneElementArray_Success()
    {
