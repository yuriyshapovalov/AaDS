...
public class CycleSortTest
{
    ...
    public void Init()
    {
        this.sorter = new CycleSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void CycleSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void CycleSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void CycleSort_OneElementArray_Success()
    {
