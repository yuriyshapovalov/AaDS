...
public class FlashSortTest
{
    ...
    public void Init()
    {
        this.sorter = new FlashSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void FlashSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void FlashSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void FlashSort_OneElementArray_Success()
    {
