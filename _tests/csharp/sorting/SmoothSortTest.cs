...
public class SmoothSortTest
{
    ...
    public void Init()
    {
        this.sorter = new SmoothSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void SmoothSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void SmoothSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void SmoothSort_OneElementArray_Success()
    {
