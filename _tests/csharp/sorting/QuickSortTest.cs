...
public class QuickSortTest
{
    ...
    public void Init()
    {
        this.sorter = new QuickSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void QuickSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void QuickSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void QuickSort_OneElementArray_Success()
    {
