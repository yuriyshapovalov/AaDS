...
public class StandSortTest
{
    ...
    public void Init()
    {
        this.sorter = new StandSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void StandSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void StandSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void StandSort_OneElementArray_Success()
    {
