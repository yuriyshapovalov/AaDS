...
public class OddEvenSortTest
{
    ...
    public void Init()
    {
        this.sorter = new OddEvenSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void OddEvenSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void OddEvenSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void OddEvenSort_OneElementArray_Success()
    {
