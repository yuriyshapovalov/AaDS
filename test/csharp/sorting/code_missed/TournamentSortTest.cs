...
public class TournamentSortTest
{
    ...
    public void Init()
    {
        this.sorter = new TournamentSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void TournamentSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void TournamentSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void TournamentSort_OneElementArray_Success()
    {
