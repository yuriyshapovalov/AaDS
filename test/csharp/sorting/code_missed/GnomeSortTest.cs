...
public class GnomeSortTest
{
    ...
    public void Init()
    {
        this.sorter = new GnomeSort<int>();
        this.provider = DataProvider.GetDataProvider();
        this.validator = Validator.GetValidator();
    }

    [Test]
    public void GnomeSort_RandomIntegerSequence_Success()
    {
    ...
    [Test]
    public void GnomeSort_EmptyArray_Success()
    {
    ...
    [Test]
    public void GnomeSort_OneElementArray_Success()
    {
